        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="{{route('admin.Pharmacies.create')}}" class="btn btn-primary" role="button"
                       aria-pressed="true">اضافة صيدلية جديدة</a>
                            ...
                            @foreach($pharmacies as $pharmacy)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <img src="{{URL::asset('admin_assets/img/pharmacy.jfif')}}" height="50px"
                                                 width="50px" alt="">
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#update_password{{$pharmacy->id}}"><i   class="text-primary ti-key"></i>&nbsp;&nbsp;تغير كلمة المرور</a>
                                ...
                                @include('admin.pharmacies.update_password')
