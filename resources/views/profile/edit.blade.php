					...
					<div class="col-lg-4">
								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{URL::asset('admin_assets/img/faces/6.png')}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
						...
						<div class="card mg-b-20">
							<div class="card-body">
								...
								<form class="form-horizontal" method="POST" action="{{ route('profile.destroy') }}">
									@csrf
									@method('delete')
