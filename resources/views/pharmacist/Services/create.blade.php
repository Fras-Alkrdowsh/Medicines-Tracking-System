...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الخدمات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة خدمة جديدة</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form action="{{route('pharmacist.Service.store')}}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="price"  value="{{old('price')}}" class="form-control @error('price') is-invalid @enderror" required>
                            <div id="emailHelp" class="form-text text-danger">
                                @error('price')
                                    {{$message}}
                                @enderror
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input class="form-control " name="type" placeholder="" value="{{old('type')}}"
                             type="text" required>
                             <div id="emailHelp" class="form-text text-danger">
                                @error('type')
                                    {{$message}}
